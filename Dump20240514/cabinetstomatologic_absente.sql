...
CREATE TABLE `absente` (
  ...
  `idAngajat` int DEFAULT NULL,
  `DataInceput` date DEFAULT NULL,
  `DataFinal` date DEFAULT NULL,
  PRIMARY KEY (`idAbsenta`),
  KEY `idAngajat` (`idAngajat`),
  CONSTRAINT `absente_ibfk_1` FOREIGN KEY (`idAngajat`) REFERENCES `angajati` (`idAngajat`)
...
INSERT INTO `absente` VALUES (1,1,'2024-04-01','2024-04-05'),(2,2,'2024-04-10','2024-04-12'),(3,1,'2024-04-01','2024-04-05'),(4,2,'2024-04-10','2024-04-12');
