...
CREATE TABLE `programari` (
  ...
  `idProcedura` int DEFAULT NULL,
  PRIMARY KEY (`IdConsultatie`),
  KEY `idPacient` (`idPacient`),
  KEY `idMedic` (`idMedic`),
  KEY `idProcedura` (`idProcedura`),
  CONSTRAINT `programari_ibfk_1` FOREIGN KEY (`idPacient`) REFERENCES `pacienti` (`idPacient`),
  CONSTRAINT `programari_ibfk_2` FOREIGN KEY (`idMedic`) REFERENCES `angajati` (`idAngajat`),
  CONSTRAINT `programari_ibfk_3` FOREIGN KEY (`idProcedura`) REFERENCES `proceduri` (`idProcedura`)
