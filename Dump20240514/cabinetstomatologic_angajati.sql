...
CREATE TABLE `angajati` (
  ...
  `TipAngajat` varchar(100) DEFAULT NULL,
  `Descriere` text,
...
INSERT INTO `angajati` VALUES (1,'Dr. John Smith','Medic','Specialist in chirurgie','john_smith.jpg'),(2,'Nurse Jane Doe','Asistent','Asistent medical cu experienta','jane_doe.jpg');
